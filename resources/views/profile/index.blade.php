              ...
              <div class="card-body">
                <form method="POST" action="/user/profile-information" class="needs-validation" novalidate="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input id="nip" type="text" class="form-control @error('nip') is-invalid @enderror" name="nip" tabindex="2" value="{{ auth()->user()->nip }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('instansi') is-invalid @enderror" name="instansi" tabindex="2" value="{{ auth()->user()->instansi }}">
                    </div>
                    <div class="form-group">
